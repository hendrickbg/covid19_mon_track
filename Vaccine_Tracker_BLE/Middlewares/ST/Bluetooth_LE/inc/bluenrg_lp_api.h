...
/**
 * @brief
 * @param Scheduler_Handle
 * @param[out] Task_Priority
 * @param[out] Task_Num_Skip_Slots
 * @param[out] Task_Interval
 * @param[out] Task_Length
 * @retval Value indicating success or error code.
 */
tBleStatus aci_hal_read_scheduler_information(uint8_t Scheduler_Handle,
                                              uint32_t *Task_Priority,
                                              uint32_t *Task_Num_Skip_Slots,
 ...
 * @retval Value indicating success or error code.
 */
tBleStatus aci_hal_get_ll_time(uint32_t *Time);
/**
 * @brief
 * @param Time
 * @retval Value indicating success or error code.
 */
tBleStatus aci_hal_set_ll_time(uint32_t Time);
/**
 * @brief
 * @param CE_Length
 * @retval Value indicating success or error code.
 ...
 */
/**
 *@defgroup GATT_API GATT Commands
