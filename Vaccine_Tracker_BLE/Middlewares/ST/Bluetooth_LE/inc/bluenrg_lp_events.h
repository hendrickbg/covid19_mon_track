 ...
 * @param Status See [Vol 2] Part D, Error Codes for a list of error codes and
 *        descriptions.
 * @param Connection_Handle Connection_Handle to be used to identify a
 *        connection.
 ...
 *        Request). After this event is received, aci_gatt_serv_resp() must be
 ...
 *        needed, application must respond with an aci_gatt_serv_resp().
